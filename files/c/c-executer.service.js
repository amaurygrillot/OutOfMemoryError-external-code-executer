...
exports.CExecuterService = void 0;
var c_executer_repository_1 = require("./c-executer.repository");
var spawn = require('child_process').spawn;
var CExecuterService = /** @class */ (function () {
    function CExecuterService() {
        this.pythonExecuterRepository = new c_executer_repository_1.CExecuterRepository();
    }
    CExecuterService.prototype.getAllInstance = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, c_executer_repository_1.CExecuterRepository.getInstance()];
                    case 1:
    ...
    CExecuterService.prototype.executeNoArgumentScript = function (fileName) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CExecuterService.prototype.executeScript = function (fileName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new Promise(function (accept, reject) {
                            ...
                            var gcc = spawn('gcc', ["files/c/".concat(fileName), '-o', 'myFile']);
    ...
    return CExecuterService;
}());
exports.CExecuterService = CExecuterService;
